                ...
                <div class="md:w-2/3 md:pl-8">
                    ...
                    <form method="POST" action="{{ route('login.store') }}">
                        ...
                        <a href="{{ route('auth.google') }}" 
                            class="flex items-center justify-center gap-3 mx-auto w-80 bg-blue-600 
                                    hover:bg-blue-700 text-white py-3 rounded-md text-lg font-semibold transition duration-200">
